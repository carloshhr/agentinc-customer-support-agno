...
├── Support Insights  (agents/support_insights.py) — separate administrator-only, on-demand aggregate reporting agent
...
| [`agents/support_insights.py`](agents/support_insights.py) | Support Insights — separate administrator-only registered agent for on-demand aggregate support reporting. |
