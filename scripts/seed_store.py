...
def seed_store() -> None:
    """Create storage, insert immutable fixtures, and index catalog Markdown once."""
    ...
    store_knowledge.insert(path=str(catalog_path), reader=MarkdownReader(), skip_if_exists=True)
